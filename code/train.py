...
with tf.device("/gpu:0"):
	...
	XYZ,maskLogit,d2 = decoder(opt,latent) # [B,H,W,3V],[B,H,W,V]
	...
	# ------ define loss ------
	loss_depth = graphv8.masked_l1_loss(newDepth-depthGT,tf.equal(collision,1))/(opt.batchSize*opt.novelN)
	loss_mask = graphv8.cross_entropy_loss(newMaskLogit,maskGT)/(opt.batchSize*opt.novelN)
